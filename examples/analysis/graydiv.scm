;; 2021-03-04.  examples/analysis/graydiv.scm
...
(use "x<<=0")
(use "xBd")
;; ?^120:x*RealUDiv y 3===(1#2)*(4*((1#2)*(x+(1#2)*y))*RealUDiv y 3+IntN 1)
(use "DivAuxEqL")
(autoreal)
(use "yLBd")
;; 6
...
(autoreal)
(use "xBd")
;; ?^343:x*RealUDiv y 3===(1#2)*(4*((1#2)*(x+ ~((1#2)*y)))*RealUDiv y 3+1)
(use "DivAuxEqR")
(autoreal)
(use "yLBd")
;; 293
...
(use "yLBd")
(autoreal)
;; ?^444:x*RealUDiv y 3===(1#2)*(2*x*RealUDiv y 3+0)
...
(assert "abs(x2*RealUDiv y 3)<<=1")
 (simpreal "RealAbsTimes")
 (use "RealLeTrans" (pt "y*RealUDiv y 3"))
